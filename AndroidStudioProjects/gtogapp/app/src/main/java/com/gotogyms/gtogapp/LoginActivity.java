...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signout=(Button)findViewById(R.id.action_logout);
        signInButton=(SignInButton)findViewById(R.id.googlelogin);
        glogin=(Button)findViewById(R.id.email_sign_in_button);
//        spinner=(ProgressBar)findViewById(R.id.progressBar);
//        spinner.setVisibility(View.GONE);
//        prof_pic=(ImageView)findViewById(R.id.profilepicture);
...
//                bgWorker.execute(type, R.id.email, R.id.password);
        }
    }
    ...
    private void updateUI(boolean isLogin) {
        if (isLogin) {
                ...
                Intent signInToMain = new Intent("com.gotogyms.gtogapp.gotogyms");
    ...
    public void onConnected(Bundle connectionHint) {
        SharedPreferences userDetailsPrefEditor = getApplicationContext().getSharedPreferences("GotogymsPrefFile", MODE_PRIVATE);
        boolean hasGUserSetDetails = userDetailsPrefEditor.getBoolean("GOUSER_SESSION_EXISTS", false);
        if (hasGUserSetDetails == true) { //If user has already entered their details show profile page, else show user details capture screen.
            Intent usrGo2gymsIntent = new Intent(this, gotogyms.class);
            startActivity(usrGo2gymsIntent);
        } else {
            Intent usrSigninIntent = new Intent(this, LoginActivity.class);
            startActivity(usrSigninIntent);
        }
    }
}
